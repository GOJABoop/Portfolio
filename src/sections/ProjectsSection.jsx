  ...
  return (
    <section className='bg-slate-300'>
      <div className='py-5 bg-neutral-900 text-center'>
        <h1 className=" text-2xl font-extrabold tracking-tight text-gray-900 md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-700">Here My Most Representative Projects</h1>
      </div>
