import  github_2 from '../../assets/icons/github_2.svg';
    ...
    <section className="bg-neutral-900" id="contact">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 ">
            <div className=" mr-auto place-self-center lg:col-span-7">
                ...
                <div className=" p-6 flex flex-wrap items-center  bg-neutral-800 rounded-md">
                    <div className="grid grid-cols-1 gap-4 bg-neutral-700 mx-2 px-5 py-2 rounded">
                        <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-100 sm:mt-0">
                            <li className='flex flex-wrap items-center'>
                                <img src={linkedin} className="h-6 w-6 mr-2" alt="linkedin" />
                            ...
                            <li className='flex flex-wrap items-center'>
                                <img src={github_2} className="h-9 w-8 mr-2" alt="GitHub" />
