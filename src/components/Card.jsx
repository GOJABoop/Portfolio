export const Card = ({ name, description, linkRepo, img }) => {
    return (
        <a href={linkRepo} target="blank" className="flex items-center mx-4 bg-slate-100 rounded-lg border shadow-md md:mx-0 md:flex-row md:w-full hover:bg-slate-200 hover:border-slate-400">
